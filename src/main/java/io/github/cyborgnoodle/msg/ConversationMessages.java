...
public class ConversationMessages {
    ...
    public static String getNotUnderstood(){

        List<String> l = new ArrayList<String>();

        l.add("what?");
        l.add("What did you say?");
        l.add("huh?");
        l.add("ahmm what?");
        l.add("whaaaat?");
        l.add("wat?");
        l.add("I didn't understand, what?");
        l.add("hmm?");
        l.add("Didn't understand you, what?");
        l.add("What? I didn't understand you");
        l.add("Whut?");
        l.add("wut?");
        l.add("wuaht??");
