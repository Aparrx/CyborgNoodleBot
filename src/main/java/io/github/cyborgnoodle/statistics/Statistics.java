...
package io.github.cyborgnoodle.statistics;
...
public class Statistics {
    ...
    private static long msgcount = 339974L;
    ...
    public static void statsTick(@Nullable User usero, @Nullable Channel channelo, Server server, int count){
        ...
        if(stats.containsKey(today)){
            ...
            if(daystats.getMinute5s().containsKey(now)){
                ...
                minstats.setAllMessageCount(msgcount+minstats.getMessageCount());

                msgcount = minstats.getAllMessageCount();
            }
            else {
